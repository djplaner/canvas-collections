/**
 * Adopted from Juice - https://github.com/Automattic/juice - a css inliner
 * Browserified client (kludge) to translate proper CSS into inline CSS/HTML ready for
 * pasting into the Canvas RCE
 */
