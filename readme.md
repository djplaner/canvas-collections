...
The image on the left below shows a standard Canvas modules page. 11 modules displayed in one vertical list. This course was designed using three driving questions. Can you tell what those questions are from the modules page?

The image on the right is the same modules page with Canvas Collections. Notice the driving questions?
