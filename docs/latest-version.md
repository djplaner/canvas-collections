...
version **0.9.4** of Canvas Collections
...
See [the 0.9.4 release notes](https://github.com/djplaner/canvas-collections/releases/tag/v0.9.4) for more information on the latest version.
